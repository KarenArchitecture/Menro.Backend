...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Menro.Domain.Entities.Cart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Menro.Domain.Entities.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Menro.Domain.Entities.CartItemExtra", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Menro.Domain.Entities.FoodCombo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Menro.Domain.Entities.Restaurant", b =>
                {
                    ...
                    b.Property<int?>("RestaurantCategoryId1")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RestaurantCategoryId1");
            ...
            modelBuilder.Entity("Menro.Domain.Entities.RestaurantTable", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Menro.Domain.Entities.CartItem", b =>
                {
                    b.HasOne("Menro.Domain.Entities.Cart", "Cart")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Menro.Domain.Entities.CartItemExtra", b =>
                {
                    b.HasOne("Menro.Domain.Entities.CartItem", "CartItem")
                        .WithMany("Extras")
            ...
            modelBuilder.Entity("Menro.Domain.Entities.FoodCombo", b =>
                {
                    b.HasOne("Menro.Domain.Entities.Food", "ComboFood")
                        .WithMany()
            ...
            modelBuilder.Entity("Menro.Domain.Entities.Restaurant", b =>
                {
                    ...
                    b.HasOne("Menro.Domain.Entities.RestaurantCategory", null)
                        ...
                        .HasForeignKey("RestaurantCategoryId1");
